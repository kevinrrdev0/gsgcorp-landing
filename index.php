...
<body>
  ...
  <header id="header" class="d-flex align-items-center">
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <h1 class="logo"><a href="index.html">GSG Corp</a></h1>
  ...
  <section id="hero" class="d-flex align-items-center">
    <div class="container position-relative" data-aos="fade-up" data-aos-delay="500">
      <h1>Bienvenido a GSG</h1>
      <h2>Profesionales expertos en Logistica de Almacenaje,<br> Transporte y Distribución</h2>
      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-lg-6 pt-4 pt-lg-0 order-2 order-lg-1 content" data-aos="fade-right">
            <h3>Horario de atención oficina: Lun - Sab 9:00am a 6:00pm</h3>
            <p class="fst-italic">
              GSG Corp es una empresa peruana fundada el 1ro de Enero del 2020 que nace con el ímpetu de brindar servicios logísticos de transporte motorizado, delivery y courier en general.
            </p>
            <ul>
              <li><i class="bi bi-check-circle"></i> Envíos rapidos y seguros.</li>
              <li><i class="bi bi-check-circle"></i> Recogemos y llevamos tus productos desde cualquier lugar.</li>
              <li><i class="bi bi-check-circle"></i> Cumplimos con estrictos protocolos de bioseguridad.</li>
            </ul>
            <p>
        ...
        <div class="row">
          ...
          <div class="col-lg-4" data-aos="fade-up">
            <div class="box">
              <span>Misión</span>
              <br>
              <p>Liderar el sector Logistico brindando un servicio diferencial a traves de la mejora continua, capacitación, información estratégica, indicadores y mejores prácticas.</p>
            </div>
          </div>
          ...
          <div class="col-lg-4 mt-4 mt-lg-0" data-aos="fade-up" data-aos-delay="150">
            <div class="box">
              <span>Visión</span>
              <br>
              <p>Ser una empresa Logisticas lider ,competitiva y confiable, brindando soluciones y servicios de calidad, basados en nuestra experiencia tecnica y conformando el mejor equipo profesional.</p>
            </div>
          </div>
          ...
          <div class="col-lg-4 mt-4 mt-lg-0" data-aos="fade-up" data-aos-delay="300">
            <div class="box">
              <span>Valores</span>
              <br>
              <p>Comprometidos con la Seguridad y La excelencia , perseguimos que todos nuestros proyectos y actividades se realicen de forma continua.</p>
              <br>
            </div>
          </div>
        ...
        <div class="row">
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch" data-aos="fade-up">
            <div class="icon-box">
              ...
              <h4><a href="">Servicio de E-Commerce </a></h4>
              <p>Si eres emprendedor y buscas que tu negocio crezca con la opción de delivery, nosotros estamos dispuestos, nuestros motorizados están aptos a llevar tus pedidos, hacer cobros y realizar cualquier otra gestión que requieras.</p>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4 mt-md-0" data-aos="fade-up" data-aos-delay="150">
            <div class="icon-box">
              ...
              <h4><a href="">Servicio Empresarial</a></h4>
              <p>Si requieres de un servicio logístico de transporte motorizado outsourcing personalizado según los requerimientos de tu empresa. ¡Este es el servicio ideal para ti!</p>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4 mt-lg-0" data-aos="fade-up" data-aos-delay="300">
            <div class="icon-box">
              ...
              <h4><a href="">Servicio Personalizado</a></h4>
              <p>Nuestros motorizados están listos para acoplarse al servicio que necesites, te proporcionaremos la mas alta garantía en nuestros traslados. 🏍🛵</p>
            </div>
          </div>
        </div>
    ...
    <section id="portfolio" class="portfolio" style="display:none">
      <div class="container">
        ...
        <div class="section-title">
          ...
          <h2>Portafolio</h2>
          <p>Adaptamos nuestros procesos para sastifacer el requerimiento de cada cliente, tomando en cuenta la seguridad y confiabilidad.</p>
        </div>
    ...
    <section id="pricing" class="pricing">
      <div class="container">
        ...
        <div class="section-title">
          <span>Precios</span>
          <h2>Precios</h2>
          <p>Encuentra los precios que necesitas para lo que buscas.</p>
        </div>
    ...
    <section id="team" class="team">
      <div class="container">
        ...
        <div class="section-title">
          <span>Equipo</span>
          <h2>Equipo</h2>
          <p>Nos encargamos de llevar tus metas al éxito, para que tú solo te preocupes por tu negocio.</p>
        </div>
        ...
        <div class="row">
          <div class="col-lg-6 col-md-6 d-flex align-items-stretch" data-aos="zoom-in">
            <div class="member">
              ...
              <h4>Maycol Calderon</h4>
              <span>Chief Executive Officer</span>
              <p>
                El encargado de llevar tu empresa al exito
              </p>
              <div class="social">
          ...
          <div class="col-lg-6 col-md-6 d-flex align-items-stretch" data-aos="zoom-in">
            <div class="member">
              ...
              <span>CTO</span>
              <p>
                Encargado de la transformacion digital de la empresa
              </p>
              <div class="social">
                <a href=""><i class="bi bi-twitter"></i></a>
                <a href=""><i class="bi bi-facebook"></i></a>
    ...
    <section id="contact" class="contact">
      <div class="container">
        ...
        <div class="section-title">
          <span>Contacto</span>
          <h2>Contacto</h2>
          <p>Si tiene alguna pregunta o desea obtener más información, no dude en ponerse en contacto con nosotros.</p>
        </div>
        ...
        <div class="row" data-aos="fade-up">
          ...
          <div class="col-lg-3 col-md-6">
            <div class="info-box  mb-4">
              ...
              <p>contacto.info@gsgcorppe.com</p>
            </div>
          </div>
